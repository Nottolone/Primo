            ...
            if(request.getParameter("idProdotto")!=null){
                ...
                if(request.getParameter("Buy")!=null){
                    ...
                    if(((Utente)session.getAttribute("utente")).getValoreSaldo()>=prodottoSelezionato.getPrezzo()){
                        if(ProdottiFactory.getInstance().acquistaProdotto(prodottoSelezionato,(Cliente)session.getAttribute("utente"))){
                            session.setAttribute("utente",UtentiFactory.getInstance().getUtente((Integer)session.getAttribute("idUtente")));
